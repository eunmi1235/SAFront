...
function imgResize(){
	...
	*/
	var div = $('.m_main_banner .slidesjs-slide .img, .ex_list_area li a, .auction_list02 li .img');
	div.each(function(){
...
function fullImg(){
	var imgs = $('.auction_list li .img, .thumb_list li, .img_represent .rolling li, .auction_h_list li .img');
	imgs.each(function(){
