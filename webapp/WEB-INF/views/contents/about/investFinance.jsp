				...
				<div class="contents">
					...
					<div class="tab_wrap type02">
						<ul>
							...
							<li class="tab sele"><a href="#">재무정보</a></li>
							<li class="tab"><a href="/about/page?view=investAnnounce">공시정보</a></li>
						...
						<div class="cont">
							<div class="invest_area"><!-- 20150630 -->
								<div>
									...
									<jsp:include page="./include_krx/financialInfo.jsp" flush="false"/>
								</div>
							</div>
						</div>
					</div>
