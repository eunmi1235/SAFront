...
<%
	String geturl = "http://asp1.krx.co.kr/servlet/krx.asp.XMLJemuEng?code=063170";
	String gettime="";
...
%>
	...
	Financial Information<span><span class="time_img"></span><%=gettime%> </span>
	</div>
	<div class="body-wrap">
		<div class="data-lists">
			<dl>
				<dt><span></span>Balance Sheet</dt>
				<dd>
					<table id="balance">
						<tr>
							<th rowspan="2">Financial item</th>
							<%if(!DaeCha_ym[0].equals("")) {%>
							<th colspan="3"><%=DaeCha_ym[0]%>. <%=DaeCha_ym[1]%></th>
							<th colspan="3"><%=DaeCha_ym[2]%>. <%=DaeCha_ym[3]%></th>
							<th colspan="3"><%=DaeCha_ym[4]%>. <%=DaeCha_ym[5]%></th>
							<%}%>
						</tr>
						<tr>
							<th>Price</th>
				...
				<dt><span></span>Income statement</dt>
				<dd>
					<table id="income_statement">
						<tr>
							<th rowspan="2">Financial item</th>
							<%if(!SonIk_ym[0].equals("")) {%>
							<th colspan="3"><%=SonIk_ym[0]%>. <%=SonIk_ym[1]%></th>
							<th colspan="3"><%=SonIk_ym[2]%>. <%=SonIk_ym[3]%></th>
							<th colspan="3"><%=SonIk_ym[4]%>. <%=SonIk_ym[5]%></th>
							<%}%>
						</tr>
						<tr>
							<th>Price</th>
				...
				<dt><span></span>Statement of cash flows</dt>
				<dd>
					<table id="cash_flow">
						<tr>
							<th rowspan="2">Financial item</th>
							<%if(!CashFlow_ym[0].equals("")) {%>
							<th colspan="2"><%=CashFlow_ym[0]%>. <%=CashFlow_ym[1]%></th>
							<th colspan="2"><%=CashFlow_ym[2]%>. <%=CashFlow_ym[3]%></th>
							<th colspan="2"><%=CashFlow_ym[4]%>. <%=CashFlow_ym[5]%></th>
							<%}%>
						</tr>
						<tr>
							<th>Price</th>
