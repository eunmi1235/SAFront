			...
			<div class="contents_wrap">
				<div class="contents">
					...
					<div class="tab_wrap type02">
						<ul>
							<li class="tab sele"><a href="/about/page?view=investRealtime">Real-Time Stock Quotes</a></li>
						...
						<div class="cont">
							<div class="invest_area"><!-- 20150630 -->
								<div>
									<!--  <iframe src="http://asp2.krx.co.kr/IR/HtmlService/063170/st_info.jsp" width="700px" height="1300px" scrolling="no" frameborder=0 z-index="-20"></iframe> -->
									<jsp:include page="./include_krx/stockInfoEng.jsp" flush="false"/>
								</div>
							</div>
						</div>
					</div>
