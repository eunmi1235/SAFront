					...
					<div class="onepcssgrid-1200 client_onepcssgrid-1200 clearfix">                  
						...
						<div class="col7 last bid_livebox bid_livebox_client">   
							...
							<div class="bid_livebox_font bid_livebox_font_en">           
								...
								<div class="hogatable client_hogatable"> 
									<label for="lastPrice">
										<font style="padding-right:5px; display:table-cell; vertical-align:middle;"><span ng-if="locale=='ko'">현재가</span><span ng-if="locale!='ko'">Current price</span></font>
									</label>
								...
								<div class="hogatable client_hogatable client_hogatable_en">  
									<label for="growPrice"> 
										<font style="padding-right:5px; display:table-cell; vertical-align:middle;"><span ng-if="locale=='ko'">호가</span><span ng-if="locale!='ko'">Asking price</span></font>
									</label>
							...
							<div class="bidlive_clinet_btn bidlive_clinet_btn_en">              
								<span class="btn_style01 green02 offauction_btn offauction_btn_en"><!-- 응찰버튼 조건 : 정회원 이거나 국외회원 응찰허용 인경우, 메이저/홍콩/기획경매만 응찰버튼 활성화 && (custInfo.MEMBERSHIP_YN == 'Y' || custInfo.FORE_BID_YN == 'Y') &&--> 
