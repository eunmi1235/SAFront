		...
		<div ng-controller="liveAuctionCtl" data-ng-init="init()">
			...
			<div><!-- 경매 진행중인 경우 -->
				...
				<div class="onepcssgrid-1200 client_onepcssgrid-1200 clearfix"> 
					<!--web_only-->
					<div class="bidlive_5010 client_web_only clearfix">       
						<!-- 웹 video -->       
						<div class="bidlive_video client_web_only"> 
								<!-- <iframe src="https://play.fastedge.net/wowza-webrtc-player/sauc.html" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true" scrolling="no" id="live_videoframe"></iframe> -->
								<video id="llnw-rts-subscriber" width="640" height="480" autoplay controls muted>
							<div class="re-flash" style="float:right; font-size:12px;">       
								<a onClick="window.location.reload()" style="cursor:pointer; display: block; color: #444;">       
                            ...
                            <div style="overflow: hidden; padding-bottom: 10px; text-align: center; font-size:14px;">   
                                <span class="notice_style01"></span>    
                                <span style="color: #f00; font-weight: bold;">동영상 시청은 크롬, 엣지에서만 시청이 가능합니다. 익스플로러는 재생이 되지 않습니다.</span> 
                            </div> 
						</div><!-- //video -->    
						
						<!-- tabs -->
						<div class="bidlive_tab clearfix" style="padding-bottom: 10px;">  
							<div class="tab">  
								...
								<div class="tab_lotcaption">  
									...
									<div class="tab_box_img_caption" style="float:left; width: 60%;">  
										...
										<span style="float:right; cursor:pointer; font-size: 12px; padding-right: 10px; color: #444;" ng-click="nowLotMove(lot.LOT_NO,lot.ARTIST_NAME_JSON[locale],lot.TITLE_JSON[locale], lot.MATE_NM_EN, lot.EXPE_PRICE_FROM_JSON[base_currency],lot.EXPE_PRICE_TO_JSON[base_currency],lot.FILE_NAME,lot.FILE_PATH)">
											<i class="material-icons" style="font-size:20px; vertical-align:text-bottom;">touch_app</i>현재 LOT이동</span>      
					...
					<div class="bidlive_50 clearfix">
						...
						<!-- 모바일 video -->   
						<div class="client_m_only clearfix" style="padding:20px 0;">
							<div class="bidlive_video">
								<!-- <iframe src="https://play.fastedge.net/wowza-webrtc-player/sauc.html" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true" scrolling="no"></iframe> --> 
								<video id="llnw-rts-subscriber" width="640" height="480" autoplay controls muted>
							</div><!-- //video -->   
                            <div style="overflow: hidden; padding-bottom: 10px; text-align: center; font-size: 12px;">   
                                <span class="notice_style01"></span>    
                                <span style="color: #f00; font-weight: bold;">동영상 시청은 크롬, 엣지에서만 시청이 가능합니다. 익스플로러는 재생이 되지 않습니다.</span> 
                            </div>    
							<div class="re-flash">       
								<a onClick="window.location.reload()" style="cursor: pointer;">     
									<i class="material-icons" style="vertical-align:middle; font-size: 18px; font-weight: bold; color: #444;">       
										refresh 
									</i>  
									동영상 새로고침     
								</a>   
							...
							<div class="bidlivenotice_list">  
								<ul>  
									<li class="txt_impo02 notice_slide_center">       
										<span class="notice_style01" style="vertical-align:middle;"></span> 온라인 응찰은 철회가 불가능합니다.  	
									</li>  
									<li class="txt_impo02">   
										 <span class="notice_style01" style="vertical-align:middle;"></span> 응찰 우선 순위는 서면 > 현장 > 온라인 순입니다.  
									</li> 
									<li class="txt_impo02">   
										 <span class="notice_style01" style="vertical-align:middle;"></span> 온라인 응찰은 응찰신청한 정회원만 가능합니다.  
									</li> 
									<li class="txt_impo02">    
										 <span class="notice_style01" style="vertical-align:middle;"></span> 동영상의 금액은 시차가 있을 수 있으니,응찰 화면의 응찰가를 확인 후 응찰 부탁드립니다.    
									</li>
									<li class="txt_impo02">    
										 <span class="notice_style01" style="vertical-align:middle;"></span> chrome(크롬),엣지(Edge) 브라우저를 이용하시길 권장합니다.  
									</li>
								</ul> 
							</div>  
						</div>  
