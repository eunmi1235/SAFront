...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
								...
								<div class="auction_list_img" oncontextmenu="return false" ondragstart="return false" ng-if="sale_status!='END'">  
									<span ng-if="sale_status == 'ING'">
										<span ng-if="is_login">
											<a ng-if="sale.SALE_NO <= '408' && lot.STAT_CD != 'reentry' && (lot.IMG_DISP_YN == 'Y' || custInfo.EMP_GB == 'Y')" ng-href="{{ is_login ? '/lotDetailPrivate?sale_no=' + sale_no + '&lot_no=' + lot.LOT_NO + '&sale_status=' + sale_status + '&view_type=LIST' : '#'}}">
											...
											<a ng-if="sale.SALE_NO >= '409' && lot.STAT_CD != 'reentry' && (lot.IMG_DISP_YN == 'Y' || custInfo.EMP_GB == 'Y')" ng-href="{{ is_login ? '/lotDetailPrivate?sale_no=' + sale_no + '&lot_no=' + lot.LOT_NO + '&sale_status=' + sale_status + '&view_type=LIST' : '#'}}">
											...
											<a ng-if="lot.STAT_CD != 'reentry' && (lot.IMG_DISP_YN != 'Y' && custInfo.EMP_GB != 'Y')" ng-href="{{ is_login ? '/lotDetailPrivate?sale_no=' + sale_no + '&lot_no=' + lot.LOT_NO + '&sale_status=' + sale_status + '&view_type=LIST' : '#'}}">
									...
									<span ng-if="sale_status != 'ING'">
										<span ng-if="is_login">
											<span ng_if="custInfo.EMP_GB == 'Y'">
												<a ng-if="sale.SALE_NO <= '408' && lot.STAT_CD != 'reentry'" ng-href="{{ is_login ? '/lotDetailPrivate?sale_no=' + sale_no + '&lot_no=' + lot.LOT_NO + '&sale_status=' + sale_status + '&view_type=LIST' : '#'}}">
													<img ng-src="<spring:eval expression="@configure['img.root.path']" />{{lot.LOT_IMG_NAME ? (lot.LOT_IMG_NAME | imagePath : lot.LOT_IMG_PATH : true) : ''}}" style="height: 100%; width: auto; margin-top: 0px;"/>
												</a>
												<a ng-if="sale.SALE_NO >= '409' && lot.STAT_CD != 'reentry'" ng-href="{{ is_login ? '/lotDetailPrivate?sale_no=' + sale_no + '&lot_no=' + lot.LOT_NO + '&sale_status=' + sale_status + '&view_type=LIST' : '#'}}">
													<img ng-src="<spring:eval expression="@configure['img.root.path']" />{{lot.LOT_IMG_NAME ? (lot.LOT_IMG_NAME | imagePath1 : lot.LOT_IMG_PATH : 'list') : ''}}" style="height: 100%; width: auto; margin-top: 0px;"/>
												</a>
											</span> 
									...
									<div class="author auction_list_author exhibition_list_author" ng-show='lot.STAT_CD != "reentry"'>
											...
											<div class="wish_btn">
												<button style="width:30px; height:30px;" type="button">
													<span ng-if="sale_status == 'ING' && lot.STAT_CD != 'reentry'">  
											             <span ng-if="sale_status == 'ING' && !custInfo.CUST_NO" class="grid_wish_btn" onClick="alert('로그인 해주세요.\n Please login for use.')"> </span>  
											             <span ng-if="custInfo.CUST_NO && lot.INTE_LOT_DEL == 'N'" class="grid_wish_btn grid_wish_btn_sele" ng-click="inteDel({'parent':this, 'sale_no':lot.SALE_NO, 'lot_no':lot.LOT_NO});" ></span>
											             <span ng-if="custInfo.CUST_NO  && lot.INTE_LOT_DEL != 'N' && lot.STAT_CD != 'reentry'" class="grid_wish_btn" ng-click="inteSave({'parent':this, 'sale_no':lot.SALE_NO, 'lot_no':lot.LOT_NO});"></span>
										            </span>
										        </button> 
											</div> 
										</div> 
										...
										<div class="explain auction_list_explain" ng-show='lot.STAT_CD != "reentry"'>
											...
											<p ng-if="locale == 'ko' && lot.MATE_NM_EN != lot.MATE_NM">
												<span ng-bind="lot.MATE_NM_EN"></span>
											</p>
