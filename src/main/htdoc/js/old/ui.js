...
$(document).ready(function(){
	...
	$('.btn_zoom').click(function(){
		// $('body').append("<div class='wrap_zoom' oncontextmenu='return false' ondragstart='return false'>" + "</div>");
		$('body').append("<div class='wrap_zoom'>" + "</div>");
		$('.wrap_zoom').load('/zoomImage .masterview', function(){
			$('#wrap').hide();
			//blockWheel();
			$('.btn_pop_close').click(function(){
...
//			zoomResize();
	...
	//리스트페이지 float top/bottom버튼
	$('.flbtn_scrollTop').click(function(){
		$("html, body").stop().animate({scrollTop: 0 }, 500);
	});

	$('.flbtn_scrollBtm').click(function(){
		$("html, body").stop().animate({scrollTop: $(".lastlot").offset().top }, 500);
	});
	...
	//모바일 메뉴 1200px 시작으로  1024->1200으로 변경  
	$(function() {  
...
function gnbLayer(){
	var winWidth = $(window).width();
	var containerH = $(window).height();//$('.container_wrap').height();
	var containerHeight = containerH - 110;//- 55;
	var containerHeight02 = containerH + 110; //+ 55;
	if(winWidth > 768){
...
function tabClick(obj){
	...
	if(obj.find(".location")) {
		...
		if(obj.hasClass("tab01")) {
			...
			if(pc_language=='zh'){  
				var mapHongkongIframe = "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.786504492016!2d114.15230611534561!3d22.286075749041935!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34040064cdfdd003%3A0xf562f5cab77b7669!2sCompass%20Offices%20-%20Nan%20Fung%20Tower%20Business%20Centre!5e0!3m2!1sko!2skr!4v1606895882830!5m2!1sko!2skr&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>"; 
			}else{
				var mapHongkongIframe = "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.786504492016!2d114.15230611534561!3d22.286075749041935!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34040064cdfdd003%3A0xf562f5cab77b7669!2sCompass%20Offices%20-%20Nan%20Fung%20Tower%20Business%20Centre!5e0!3m2!1sko!2skr!4v1606895882830!5m2!1sko!2skr&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>"; 
			} 
			...
			if(pc_language=='zh'){
				var mapBusanIframe = "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.8636757459644!2d129.1608617156171!3d35.16002046598623!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35688d5d1bb45f6f%3A0x9c6be703064cd34b!2z67aA7IKw6rSR7Jet7IucIO2VtOyatOuMgOq1rCDspJHrj5kg7ZW07Jq064yA7ZW067OA66GcIDI5Mg!5e0!3m2!1sko!2skr!4v1601268639914!5m2!1sko!2skr&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>";
			} else  {
				var mapBusanIframe = "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.8636757459644!2d129.1608617156171!3d35.16002046598623!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35688d5d1bb45f6f%3A0x9c6be703064cd34b!2z67aA7IKw6rSR7Jet7IucIO2VtOyatOuMgOq1rCDspJHrj5kg7ZW07Jq064yA7ZW067OA66GcIDI5Mg!5e0!3m2!1sko!2skr!4v1601268639914!5m2!1sko!2skr&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>"; 
			}
			...
			if(pc_language=='zh'){
				var mapGangnamIframe = "<iframe src='http://www.google.cn/maps/embed?pb=!1m18!1m12!1m3!1d3164.377480931229!2d127.0347639492509!3d37.52259809326109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca3896760d3c7%3A0x2591c9fdbba52e9e!2z7ISc7Jq47Jil7IWY67iU66Oo!5e0!3m2!1sko!2scn!4v1521449254327&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>";
			}else{
				var mapGangnamIframe = "<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3164.377527299899!2d127.03624299999998!3d37.522597!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca38966676653%3A0xa13e5d124dfdf36d!2z7ISc7Jq47Jil7IWY6rCV64Ko7KCQ!5e0!3m2!1sko!2s!4v1431436304127&key=AIzaSyAsNYEu50L2cUvOpslYGvGik1jKbLliqWI&amp;language=KO' width='" + nFrameWidth + "' height='500' frameborder='0' style='border:0'></iframe>";
			}
...
function imgResize(){ 
	...
	*/
	var div = $('.m_main_banner .slidesjs-slide .img, .ex_list_area li a, .auction_list02 li .img, .auction_list > ul > li .auction_list_img, .auction_list > ul > li .result_auction_img, .auction_h_list ul li .wraph .img, .auction_h_list ul li .wraph .result_auction_img, .newsletter_contentsbox .newsletter_gridbox_img');
	div.each(function(){ 
...
function fullImg(){      
	/*var imgs = $('.auction_list li .img, .thumb_list li, .img_represent .rolling li, .auction_list > ul > li .auction_list_img, .auction_list > ul > li .result_auction_img, .auction_h_list ul li .wraph .result_auction_img, .newsletter_contentsbox .newsletter_gridbox_img, .academy_list .academy_img');*/    
	var imgs = $('.auction_list li .img, .auction_list > ul > li .result_auction_img, .auction_h_list ul li .wraph .result_auction_img, .newsletter_contentsbox .newsletter_gridbox_img, .academy_list .academy_img');    
	imgs.each(function(){  
...
//		if(contHeight < restHeightM){  									//YDH 2018.09.02주석처리
//			if($('#wrap').hasClass('upcoming')){						//YDH 2018.09.02주석처리	
//				$('.contents').css('height', restHeightM02 + 'px');		//YDH 2018.09.02주석처리
//			} else {													//YDH 2018.09.02주석처리
//				$('.contents').css('height', restHeightM + 'px');		//YDH 2018.09.02주석처리	
//			}															//YDH 2018.09.02주석처리
//		} else {														//YDH 2018.09.02주석처리
			$('.contents').css('height', 'auto');
//		}																//YDH 2018.09.02주석처리	
