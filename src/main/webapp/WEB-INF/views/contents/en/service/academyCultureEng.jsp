...
app.controller('academyListCtl', function($scope, consts, common) {0
	...
	$scope.academyCnt = 0;
 	...
 	$scope.loadAcademyList = function($page){
 		...
 		$d = {"baseParms":{"academy_cd":"culture"},
 				"actionList":[
									...
									<div >
										<span>
											...
											<a href="#" onClick="return false;" style="cursor: default;">
												<img ng-src="<spring:eval expression="@configure['img.root.path']" />{{art.IMG_PATH_EN}}/{{art.FILE_NAME_EN}}" alt='AMOUR CULTURE' height="200" width="200"/>
											</a>
											</div>
										</span>	
										<span>
											<div style="padding-left:30px;float:left;">
					    						...
					    						<span class="btn_style01 white02" style="margin-top:10px;">  
													...
													<a href="/academyCultureView?academy_no={{art.ACADEMY_NO}}"><spring:message code="label.academy.detail" /></a>
												</span>		
											</div>
										</span>																			
									</div>	
