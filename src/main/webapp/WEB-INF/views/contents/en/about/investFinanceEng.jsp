				...
				<div class="contents">
					...
					<div class="tab_wrap type02">
						<ul>
							...
							<li class="tab sele"><a href="/about/page?view=investFinance">Financial Information</a></li>
							<li class="tab"><a href="/about/page?view=investAnnounce">Disclosure Information</a></li>
							<li class="tab"><a href="/about/page?view=investIR">IR Information</a></li>
						</ul>
						<div class="cont">
							<div class="invest_area"><!-- 20150630 -->
								<div>
									<!--  <iframe src="http://asp2.krx.co.kr/IR/HtmlService/063170/fnc_info.jsp" width="700px" height="1450px" scrolling="no" frameborder=0 z-index="-20"></iframe> -->
									<jsp:include page="./include_krx/financialInfoEng.jsp" flush="false"/>
								</div>
							</div>
						</div>
					</div>
