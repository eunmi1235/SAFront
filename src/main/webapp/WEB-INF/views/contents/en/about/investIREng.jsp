				...
				<div class="contents">
					...
					<div class="tab_wrap type02">
						<ul>
							...
							<li class="tab sele"><a href="/about/page?view=investIR">IR Information</a></li>
						</ul>
						<div class="cont">
							<div class="invest_area"><!-- 20150630 -->
								<div>
									<iframe src="http://asp2.krx.co.kr/IR/HtmlService/063170/ir_info.jsp" width="700px" height="500px" scrolling="no" frameborder=0 z-index="-20"></iframe>
								</div>
							</div>
						</div>
					</div>
