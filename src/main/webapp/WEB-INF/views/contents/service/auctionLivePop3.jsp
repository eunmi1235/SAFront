    ...
    <div class="pop_wrap">
        ...
        <div  ng-controller="liveAuctionCtl" data-ng-init="loadLiveAuction()">            
            ...
            <div class="cont">
                ...
                <div class="onepcssgrid-1200">
                    ...
                    <div class="col5" style="padding-bottom:40px;">
	                    <!--img-->
                       <div class="web_only">
     ...
     <div style="background-color:#e4e4e4; padding:10px; text-align:left;">	 
          <div class="web_only" align="center">
              <p style="color: #000; font-size:11px; padding-top:20px; padding-bottom:20px; line-height:18px;">* LOT정보와  Live중계, Current Bidding은 시차가 발생할 수 있습니다. *<br/>재생오류 해결방법:Chrome, Edge, firefox 등 HTML5 지원 브라우저 사용 또는 브라우저 업그레이드를 권장합니다.<br/>자바스크립트를 모든 사이트에서 항상 실행을 하도록 하거나 캐시와 쿠키 삭제, 스피커 입력장치 연결을 확인해 주세요.</p>
          </div><!--web_only-->
          <div class="m_only" align="center">
              <p style="color:#C00; font-size:12px; padding-top:20px; padding-bottom:20px; line-height:18px;">* 3G/LTE 등으로 재생 시 데이터 사용료가 발생할 수 있습니다.</p>
          </div><!--m_only-->
     </div><!--footer-->
