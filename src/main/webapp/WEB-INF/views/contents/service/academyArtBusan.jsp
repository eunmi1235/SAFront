									...
									<div >
										<span>
											...
											<a href="#" onClick="return false;" style="cursor: default;">
												<img ng-src="<spring:eval expression="@configure['img.root.path']" />{{art.IMG_PATH}}/{{art.FILE_NAME}}" alt='예술소요(부산)' height="200" width="200"/>
											</a>
											</div>
										</span>	   
										<span>
											<div style="padding-left:30px;float:left;">
												...
												<!-- <span ng-if="art.ACADEMY_COMPLETE == 0 && is_login=='true' && (art.ACADEMY_PAY !=null && art.ACADEMY_PAY != 0) && art.TO_DT.substring(0,10) > db_now" class="btn_style01 white02" style="margin-top:10px;">
													<a href="page?view=academyApplication&?academy_no={{art.ACADEMY_NO}}" ><span ng-if="locale=='ko'">결제하기</span></a> 
												</span><!--결제하기-로그인O->	
