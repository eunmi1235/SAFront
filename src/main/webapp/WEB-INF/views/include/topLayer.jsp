	...
	<c:if test="${locale == 'ko'}">  <!-- 국문페이지인 경우만 오픈 -->
		<div class="curtain_wrap">
			<a href="https://www.auctionblue.com/" target="blank">
				<img id="topLayerImage" src="nas_img/front/homepage/blue1.jpg" alt="옥션블루 온라인 경매" />   <!-- PC버전 이미지 링크. htdoc/images/img/img_banner_960.png(웹), img_banner_768.png(패드), img_banner_320.png(모바일 -->
			</a>
